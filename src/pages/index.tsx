  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Restaurant Booking Engine - Streamlining Your Dining Experience. An innovative restaurant management app where customers reserve tables and employees manage reservations and menus."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Restaurant Booking Engine - Streamlining Your Dining Experience. An innovative restaurant management app where customers reserve tables and employees manage reservations and menus.`}
            </Text>
            <Box
